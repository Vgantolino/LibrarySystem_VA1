...
namespace LibrarySystem_VA.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = LibrarySystem_VAConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(LibrarySystem_VADbContext context)
        {
            _context = context;
        }
