...
{
    public class BookCategoryController : LibrarySystem_VAControllerBase
    {
        private IBookCategoryAppService _BookCategoryAppService;
        private IDepartmentAppService _departmentAppService;

        public BookCategoryController(IBookCategoryAppService bookCategoryAppService, IDepartmentAppService departmentAppService)
        {
