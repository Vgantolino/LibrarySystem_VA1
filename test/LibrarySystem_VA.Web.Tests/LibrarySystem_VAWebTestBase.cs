...
{
    public abstract class LibrarySystem_VAWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibrarySystem_VAWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibrarySystem_VAWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LibrarySystem_VADbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LibrarySystem_VADbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibrarySystem_VADbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibrarySystem_VADbContext, Task<T>> func)
        {
            T result;
